...
provider "registry.terraform.io/azure/azapi" {
  version     = "2.7.0"
  constraints = ">= 1.14.0, ~> 2.0, ~> 2.4, ~> 2.5, >= 2.7.0, < 3.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/azurerm" {
  version     = "4.54.0"
  constraints = ">= 3.71.0, >= 3.116.0, >= 3.117.0, ~> 4.0, >= 4.1.0, >= 4.8.0, >= 4.19.0, >= 4.21.1, ~> 4.38, < 5.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/random" {
  version     = "3.7.2"
  constraints = ">= 3.0.0, >= 3.5.0, ~> 3.5, ~> 3.6, ~> 3.7, < 4.0.0"
  hashes = [
